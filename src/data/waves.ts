...
export const WAVES: WaveDef[] = [
  ...
  // W12 — 탱커 종대
  {
    groups: [
      ...
      { enemy: 'runner', count: 8, interval: 0.6, direction: 'right', startDelay: 2 },
    ],
  },
  // W13
  {
  ...
  // W14
  {
    groups: [
      ...
      { enemy: 'grunt', count: 8, interval: 0.8, direction: 'top' },
    ],
  },
  // W15 — 보스 + 전방향 개시
  {
  ...
  // W17 — 상하 물량 + 좌우 탱커
  {
    groups: [
      ...
      { enemy: 'grunt', count: 14, interval: 0.55, direction: 'bottom' },
  ...
  // W19 — 총력전 전초
  {
    groups: [
      ...
      { enemy: 'grunt', count: 12, interval: 0.5, direction: 'left' },
  ...
  // W20 — 최종 보스 + 전 종류 혼합
  {
    groups: [
      ...
      { enemy: 'grunt', count: 12, interval: 0.7, direction: 'top', startDelay: 4 },
